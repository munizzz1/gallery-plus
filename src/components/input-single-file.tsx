...
import FileIconImage from "../assets/icons/image.svg?react";

export const inputSingleFileVariants = tv({
  base: `
    flex flex-col items-center justify-center w-full border border-solid
    border-border-primary group-hover:border-border-active rouded-lg gap-1
    transition
  `,
  variants: {
    size: {
...
export default function InputSingleFile({
  ...
  function isValidSize() {
    return fileSize <= maxFileSizeInMB * 1024 * 1024; //tamanho em MB
  }
